...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/css/endors/css/extensions/timedropper.min.css')}}">
...
<script src="{{asset('assets/admin/js/scripts/extensions/block-ui.js')}}" type="text/javascript"></script>
