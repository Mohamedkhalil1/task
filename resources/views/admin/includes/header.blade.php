...
<nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-without-dd-arrow fixed-top navbar-semi-dark navbar-shadow" style="background-color:currentcolor">
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item mr-auto">
            <a class="navbar-brand" href="{{route('admin.dashboard')}}">
              ...
              <h3 class="brand-text">Task Variant</h3>
            </a>
            ...
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                ...
                <span class="avatar avatar-online">
                  <img src="{{asset('assets/avatar.jpg')}}" alt="avatar"><i></i></span>
              </a>
